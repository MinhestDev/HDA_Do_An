        ...
        <div id="header" style="background: #5c8d89; height: 100px">
            <div class="container">
                <div class="row" id="header-main">
                    <div class="col-md-2">
                        <a href="">
                        <img width="80%" src="https://shoop.vn/shoop_vn/uploads/2018/06/logo-shoop-c.png">
                        </a>
                    </div>
                    ...
                    <div class="col-md-2" id="header-right">
                        <div class="pull-right">
                            ...
                            <div class="pull-right">
                                <p id="hotline" style="color: #fff"> Liên hệ</p>
                                <p style="color: #fff"> (0123) 456 789</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-3  fixside" >
            ...
            <div class="box-left box-menu">
                ...
                <ul>
                      ...
                      <div class="panel-body"><p><span class="glyphicon glyphicon-map-marker"></span> Hà Nội</p></div>
                     <div class="panel-body"> <p><span class="glyphicon glyphicon-phone"></span> Phone: (0123) 456 789</p></div>
